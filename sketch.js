...
let scream
let face_click = false
let person1_click = false
let person2_click = false
let water_click = false
let yellow_click = false
let brown_click = false
...
function mouseDragged() {
    ...
    if (c[0] == 255 && c[1] == 145 && c[2] == 0) {
        print("orange 1")
        osc.setType("sine")
        
    }

    if (c[0] == 255 && c[1] == 115 && c[2] == 0) {
        print("orange 2")
        osc.setType("sawtooth")
    }

    if (c[0] == 255 && c[1] == 180 && c[2] == 0) {
        print("yellow 1")
        osc.setType("square")
    }

    if (c[0] == 245 && c[1] == 15 && c[2] == 0) {
        print("red")
        osc.setType("triangle")
    }

    if (c[0] == 244 && c[1] == 95 && c[2] == 0) {
        print("orange 3")
        osc.setType("sine")
    }
